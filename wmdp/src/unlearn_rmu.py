...
from src.utils_rmu import load_model, get_params, forward_with_cache, get_data
...
def run_rmu(
    ...
    if args.output_dir:
        ...
        path = f"../wmdp_unlearn/{args.model_name_or_path}_alpha-{args.alpha}_batches-{num_batches}_layer-{args.layer_id}_{date}"
