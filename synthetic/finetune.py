from data_module import TextDatasetNames, custom_data_collator
...
def main(cfg):
    ...
    max_length = 500
    file_name = 'common_names_ft.txt'
    torch_format_dataset = TextDatasetNames(tokenizer=tokenizer, model_family = cfg.model_family, max_length=max_length, file=file_name)
    ...
    training_args = transformers.TrainingArguments(
            ...
            warmup_steps=max(2, max_steps//cfg.num_epochs),
            max_steps=max_steps,
