from data_module import TextDatasetNamesForget
...
def main(cfg):
    ...
    torch_format_dataset = TextDatasetNamesForget(tokenizer=tokenizer, model_family = cfg.model_family, max_length=max_length, file=file_name)
